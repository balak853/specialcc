...
async def mchkfunc2(fullcc, user_id):
    retries = 3
...
- 𝐒𝐭𝐚𝐭𝐮𝐬 - Processing...⌛️
        ...
        text = f"""
<b>↯ MASS SITEBASE [1£] [/ccs]

Number Of CC Check : [{len(ccs)}] ,limit: 25
</b> \n
"""
        ...
        works = [mchkfunc2(i, user_id) for i in ccs]
