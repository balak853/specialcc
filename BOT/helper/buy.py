...
async def show_payment_methods(client, callback_query):
    try:
        payment_info = """
📝 <b>BALAK Checker⚡️ Methods:</b>
━━━━━━━━━━━━━━

💰 <b>UPI ID/PAY</b> - <code>AVAILABLE</code>

💰 <b>BTC</b> - <code>NOT-AVAILABLE</code>

💰 <b>USDT [BEP20]</b> - <code>NOT-AVAILABLE</code>
...
async def close_message(client, callback_query):
    try:
        ...
        await callback_query.message.reply_text("Enjoy Bachhe @Special_checker_bot")
