...
BALAK Checker  Has plenty of Commands . We Have Auth Gates , Charge Gates , Tools And Other Things .
...
Click Each of Them Below to Know Them Better.</b>
    ...
    if CallbackQuery.data == "close":
        ...
        await CallbackQuery.message.reply_text("Enjoy Bachhe, @Special_checker_bot")
...
Click on each one below to get to know them better. .</b>
    ...
    if CallbackQuery.data == "Auth2":
        CHARGE_TEXT = """
🔹 Stripe Auth Gates of BALAK Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "Adyen2":
        CHARGE_TEXT = """
🔹 Adyen Auth Gates of BALAK Checker
🔹 Status: Inactive ❌
...
"""
    ...
    if CallbackQuery.data == "BRAINTREEVBV":
        CHARGE_TEXT = """
🔹 Braintree Gates of BALAK Checker
🔹 Status: ✅ Active
...
Click on each one below to get to know them better. .</b>
    ...
    if CallbackQuery.data == "PAYPAL":
        CHARGE_TEXT = """
🔹 PayPal Charge Gates of BALAK Checker
🔹 Status: ❌ Inactive
...
"""
    ...
    if CallbackQuery.data == "SKBASED":
        CHARGE_TEXT = """
🔹 Stripe Charge Gates of BALAK Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "SITE":
        CHARGE_TEXT = """
🔹 Site Charge Gates of BALAK Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "BRAINTREE":
        CHARGE_TEXT = """
🔹 Braintree Charge Gates of BALAK Checker
🔹 Status: ✅ Active
...
🔹 Shopify Charge Gates of BALAK Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "SCRAPPER":
        CHARGE_TEXT = """
🔹 Scrapper Tools Gates of BALAK Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "GENARATORTOOLS":
        CHARGE_TEXT = """
🔹 Generator Tools of BALAK Checker
🔹 Status: ✅ Active
...
"""
    ...
    if CallbackQuery.data == "BINANDOTHERS":
        CHARGE_TEXT = """
🔹 Bin and Other Tools Of BALAK Checker
🔹 Status: ✅ Active
...
Click on each one below to get to know them better.</b>
    ...
    if CallbackQuery.data == "INFO":
        CHARGE_TEXT = """
🔹 Helper Gates of BALAK Checker
🔹 Status: ✅ Active

🚀 Quick Commands Overview:

👤 Account Management:
   1. Start Bot: /start@Special_checker_bot
   2. Register: /register
   3. User ID: /id
   4. User Info: /info
